...
<p align="center">
  Building infrastructure for <b>AI agents</b> — MCP tools, plugin ecosystems, agent orchestration, and distributed training.<br/><br/>
...
- 👁️ **[mcp-vision-bridge](https://github.com/KuaaMU/mcp-vision-bridge)** — Give text-only LLM agents vision: an MCP server that routes images through any multimodal model (mimo, Claude, Gemini). Plugin + one-command installer, works across Claude Code / Codex / opencode. `TypeScript · MCP`
- 📦 **[agent-plugins](https://github.com/KuaaMU/agent-plugins)** — A Claude Code plugin marketplace: install agent extensions in one command. `Marketplace`
- 🔁 **[Auto-PR Workflow](https://github.com/KuaaMU/auto-pr-workflow)** — AI agents that autonomously submit high-quality PRs. `Python · Claude Code`
...
- 🏗️ **[Infrasys-AI/AIInfra](https://github.com/Infrasys-AI/AIInfra)** — 11 PRs: Megatron-LM, ZeRO memory optimization, TP/PP, MoE, OpenCompass.
- 🔧 **[anthropics/claude-agent-sdk-python](https://github.com/anthropics/claude-agent-sdk-python)** — Windows CLI path handling, test fixes.
- ⚙️ **[warpdotdev/warp](https://github.com/warpdotdev/warp)** — Hermes CLI agent detection.

<sub>35+ merged PRs total across 15+ projects.</sub>
